...
def send_email(keyword, date_str, blog_post, product_copy):
    ...
    html_body = f"""<html><body style="font-family:Arial,sans-serif;max-width:800px;margin:0 auto;padding:20px;">
<h1 style="color:#2d6a4f;border-bottom:3px solid #2d6a4f;padding-bottom:10px;">🌿 Liberty In a Can — Daily SEO Content</h1>
...
<br><p style="color:#888;font-size:12px;">Generated by LIAC SEO Agent</p>
</body></html>"""
